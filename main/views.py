...
from .models import JourneyMilestone,TeamMember,Brand,JobRole, CareerApplication,MapLocation, MapConnection
...
def Home(request):
    """Home page view with dynamic map"""
...
def about(request):
    ...
    # Get all active journey milestones ordered by year
...
#     """Automotive page view"""
#     context = {
#         'page_title': 'Automotive - Sparrow International',
#         'active_page': 'automotive'
#     }
#     return render(request, 'automotive.html', context)

# def shell_lubricants(request):
#     """Shell Lubricants page view"""
#     context = {
#         'page_title': 'Shell Lubricants - Sparrow International',
#         'active_page': 'shell_lubricants'
#     }
#     return render(request, 'shell-singlepage.html', context)

# def two_three_wheeler(request):
#     """Two & Three Wheeler page view"""
#     context = {
#         'page_title': 'Two & Three Wheeler - Sparrow International',
#         'active_page': 'two_three_wheeler'
#     }
#     return render(request, 'two&threewheeler.html', context)

# def it_technology(request):
    """IT & Technology page view"""
    context = {
        'page_title': 'Technology & IT Industry - Sparrow International',
        'active_page': 'it_technology'
    }
    return render(request, 'it&technology.html', context)
...
def career(request):
    ...
    # Get recent jobs for sidebar (max 3)
...
def custom_404(request, exception=None):  # ← exception=None is important
